...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { name: 'Attendance', path: '/attendance', icon: 'solar:user-check-rounded-bold-duotone' },
    { name: 'Student List', path: '/students', icon: 'solar:notebook-bookmark-bold-duotone' },
    // NEW ITEMS ADDED HERE
    { name: 'Users List', path: '/users', icon: 'solar:users-group-rounded-bold-duotone' },
  ...
  return (
    ...
    >
      {/* 1. TOP LOGO AREA */}
      <div className="h-24 flex items-center px-6 gap-4 overflow-hidden relative">
        <motion.div 
          whileHover={{ 
            scale: 1.15,
      ...
      {/* 3. FOOTER */}
      <div className={`p-4 mt-auto border-t space-y-4 ${darkMode ? 'border-white/5 bg-white/[0.01]' : 'border-slate-100 bg-slate-50'}`}>
