    ...
    <div className={`h-screen w-full relative overflow-hidden transition-colors duration-500 ${darkMode ? 'bg-[#020617] text-slate-50' : 'bg-white text-slate-900'}`}>
      ...
      <main className="flex h-full w-full">
        ...
        <section className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 z-10 relative">
          ...
          >
            <div className="mb-6 sm:mb-10">
              <h1 className="text-4xl sm:text-5xl font-black leading-none mb-2 sm:mb-3 tracking-tighter">Register</h1>
              <p className="opacity-50 font-medium text-base sm:text-lg">Secure your workspace access.</p>
            </div>
            ...
            <form className="grid grid-cols-2 gap-3 sm:gap-4" onSubmit={handleRegister}>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="col-span-2 mt-4 sm:mt-6 py-4 sm:py-5 rounded-xl sm:rounded-2xl bg-indigo-600 text-white font-black text-xs uppercase tracking-widest shadow-2xl shadow-indigo-500/40"
              >
        ...
        <section className="hidden lg:flex flex-1 relative items-center justify-center">
          ...
          <div className="relative z-10 w-2/3 flex flex-col gap-12">
            <motion.div 
            ...
            <div className="text-white">
              <h2 className="text-6xl font-black leading-[0.9] tracking-tighter mb-8">
                Experience <br /> <span className="text-indigo-300">Precision.</span>
              </h2>
