...
const LandingPage = () => {
  ...
  return (
    <div
      ...
      ref={containerRef}
      className="bg-black text-white overflow-x-hidden selection:bg-cyan-500 selection:text-black font-sans"
    >
   ...
   <SpotlightNavbar/>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 mt-10">
              <p className="text-xl md:text-3xl font-light tracking-widest uppercase text-gray-400">
                Institutional <span className="text-white">Logic</span> &
                Infrastructure
              </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            ...
            <ParallaxElement key={i} speed={i * 0.5 + 0.5}>
              ...
              >
                <div
                  className={`w-16 h-16 ${item.color} rounded-2xl mb-8 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform text-black`}
                >
                  {item.icon}
                </div>
                <h3 className="text-4xl font-bold mb-4 tracking-tighter uppercase italic">
                  {item.title}
                </h3>
      ...
      <section className="relative min-h-screen py-40 flex items-center justify-center bg-zinc-950">
        <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-24 items-center px-6">
          <div className="z-10">
            <h2 className="text-8xl md:text-[120px] font-black leading-none uppercase italic mb-8">
              Cash <br /> Flow.
            </h2>
            <p className="text-2xl text-gray-500 mb-12 max-w-md italic leading-relaxed font-light">
              ...
              <span className="text-white">$2M+ in revenue</span> with 42ms
              latency.
            </p>
            <div className="flex flex-wrap gap-4">
              <div className="px-8 py-4 rounded-full border border-cyan-500/50 text-cyan-400 font-bold uppercase tracking-widest text-xs bg-cyan-500/5">
                MongoDB Aggregation
              </div>
              <div className="px-8 py-4 rounded-full border border-white/10 text-gray-500 font-bold uppercase tracking-widest text-xs">
                Ledger v4
              </div>
            </div>
          </div>
          ...
          <div className="relative h-150 w-full">
            <ParallaxElement
              speed={2}
              className="absolute inset-0 bg-cyan-500 rounded-[4rem] z-0 opacity-10 blur-[100px]"
            />
            <ParallaxElement
              speed={-1}
              className="absolute inset-0 bg-zinc-900 border border-white/10 rounded-[4rem] z-10 p-16 shadow-2xl flex flex-col justify-center"
            >
            ...
            <ParallaxElement
              speed={3}
              className="absolute -bottom-10 -right-10 z-20 bg-white p-10 rounded-3xl shadow-2xl rotate-6 text-black"
            >
              <p className="text-xs font-black uppercase tracking-[0.2em] text-gray-400 mb-2">
                Collection Rate
              </p>
              <h5 className="text-6xl font-black tracking-tighter italic">
                92.4%
              </h5>
            </ParallaxElement>
          </div>
      ...
      <section className="relative py-48 bg-cyan-600 overflow-hidden">
        <ParallaxElement
          speed={-4}
          className="absolute -right-60 -top-60 opacity-30"
        >
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-20 relative z-10">
          {[
            ...
            >
              <h2 className="text-6xl md:text-8xl font-black text-white mb-2 italic tracking-tighter">
                {stat.val}
              </h2>
              <p className="text-cyan-900 uppercase font-black text-sm tracking-widest">
                {stat.label}
              </p>
            </ParallaxElement>
          ))}
      ...
      <section className="h-screen flex items-center justify-center relative overflow-hidden bg-black">
        ...
        <div className="z-10 text-center max-w-4xl px-6">
          ...
          <h2 className="text-7xl md:text-9xl font-black uppercase italic mb-10 tracking-tighter">
            Secure <br /> Vault.
          </h2>
          <p className="text-gray-500 text-2xl md:text-3xl font-light italic leading-relaxed">
            Every request is signed and verified.{" "}
            <span className="text-white font-bold italic">Zero-Trust</span>{" "}
      ...
      <section className="py-60 bg-zinc-950">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-24 items-center">
          <div className="order-2 md:order-1">
            <h2 className="text-7xl font-black italic mb-8 uppercase leading-none">
              Zero <br /> Friction.
            </h2>
            ...
            <ParallaxElement speed={1.5}>
              <div className="bg-black border border-white/5 rounded-[4rem] p-16 relative overflow-hidden shadow-3xl">
                <div className="absolute top-0 right-0 p-12">
                  <Activity size={120} className="text-cyan-500/10" />
                </div>
                <h3 className="text-4xl font-black mb-10 italic uppercase text-cyan-500">
                  Live Infrastructure.
                </h3>
                <div className="space-y-6 font-mono text-sm md:text-base">
                  <p className="text-emerald-400/80 tracking-tighter">
                    &gt; [23:00:00] CRON_SWEEP_EXECUTED
                  </p>
                  <p className="text-gray-500 tracking-tighter">
                    &gt; [23:00:42] LOGGED: 142 ABSENT_RECORDS
                  </p>
                  <p className="text-cyan-400/80 tracking-tighter">
        ...
        <div className="relative">
            ...
            <div className="w-[320px] h-[650px] bg-zinc-900 border-[12px] border-zinc-800 rounded-[3.5rem] shadow-[0_0_100px_rgba(0,0,0,0.8)] p-4">
              <div className="w-full h-full bg-cyan-500 rounded-[2.5rem] flex items-center justify-center overflow-hidden">
                <div className="text-center">
                  ...
                  <p className="text-black font-black italic uppercase tracking-widest text-xs">
                    Attendex Mobile
                  </p>
                </div>
              </div>
          ...
          <ParallaxElement speed={-2} className="absolute -top-40 -left-60 z-0">
            <div className="w-[600px] h-[600px] bg-white/[0.02] rounded-full border border-white/5 flex items-center justify-center">
              <p className="text-white/[0.05] font-black text-8xl rotate-90 uppercase italic whitespace-nowrap">
                RESPONSE ENGINE
              </p>
            </div>
          </ParallaxElement>
      ...
      <section className="py-60 max-w-7xl mx-auto px-6">
        <h2 className="text-6xl md:text-9xl font-black mb-32 text-center italic uppercase tracking-tighter">
          The Stack.
        </h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <ParallaxElement
              key={i}
              speed={i % 2 === 0 ? 0.5 : -0.5}
              className="p-16 bg-zinc-900 border border-white/5 rounded-[3rem] flex flex-col items-center justify-center hover:bg-white hover:text-black transition-all duration-500 group cursor-pointer shadow-xl"
            >
      ...
      <section className="h-screen flex flex-col items-center justify-center relative overflow-hidden bg-black">
        ...
        <div className="z-10 text-center px-4">
          ...
          <button className="group relative px-20 py-10 bg-white text-black text-2xl md:text-4xl font-black rounded-full overflow-hidden transition-all hover:pr-32 shadow-[0_0_50px_rgba(255,255,255,0.2)]">
            ...
            <span className="absolute right-12 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-all">
              →
            </span>
          </button>
        </div>
      ...
      <footer className="py-24 border-t border-white/5 text-center px-6">
        <div className="text-3xl font-black italic mb-8 text-white">
          ATTENDEX
        </div>
