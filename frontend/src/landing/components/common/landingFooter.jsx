      ...
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <p className="text-zinc-500 dark:text-zinc-400 text-sm leading-relaxed max-w-xs">
                Premium institutional logic and attendance infrastructure. Engineered by 
                <span className="text-black dark:text-white font-semibold ml-1">Muhammed Faris</span>.
              </p>

              <div className="flex gap-3">
                {[
                  { icon: <Github size={18} />, href: "https://github.com/muhammedfariis" },
                  { icon: <Globe size={18} />, href: "https://muhammedfarisportfolio.netlify.app" },
                  { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/muhammed-faris-431270375" }
                ].map((social, i) => (
                  <motion.a
                    key={i}
                    href={social.href}
          ...
          <div className="mt-16 pt-10 pb-8 border glass-border flex flex-col items-center justify-center text-center rounded-[2rem] space-y-8 
            ...
            <div className="flex flex-wrap justify-center gap-4">
                <div className="flex items-center gap-2 px-5 py-2 bg-white/50 dark:bg-black/50 rounded-full border glass-border">
                    ...
                    <span className="text-[10px] font-bold uppercase text-emerald-600 tracking-wider">Protocol Active</span>
                </div>
                <div className="flex items-center gap-2 px-5 py-2 bg-white/50 dark:bg-black/50 rounded-full border glass-border">
                    <Globe size={12} className="text-blue-500" />
                    <span className="text-[10px] font-bold uppercase text-blue-500 tracking-wider">Global v4.0</span>
                </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 flex flex-col md:flex-row justify-between items-center gap-6 px-2">
           <div className="flex items-center gap-2 text-zinc-400 dark:text-zinc-600">
             ...
             <span className="text-[10px] font-bold uppercase tracking-widest">Muhammed Faris</span>
           </div>
